...
class MoveCalculator:
    ...
    # メソッド
    # ==================================
    def calc_common_moves(self, curr_board, fromY, fromX, piece, turn):
        """
        ...
        if (piece[1] == "K"):
            mobiles = self.calc_castling(mobiles, curr_board, turn)
    ...
    def calc_castling(self, mobiles, curr_board, turn):
        """
        キャスリングができるかどうかの判定
        引数：
            mobiles, 移動可能セルのリスト
